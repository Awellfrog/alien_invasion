...
class Scoreboard():
    ...
    def prep_score(self):
        """将得分转化为一幅渲染的图"""
        rounded_score = int(round(self.stats.score, -1))    # 将得分近似到10的整数倍
        score_str = "Score: " + "{:,}".format(rounded_score)    # 10000 -> 10,000
    ...
    def prep_level(self):
        ...
        self.level_rect.left = self.high_score_rect.left
